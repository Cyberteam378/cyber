...
echo $i" |"$cy"     INDONESIA HACKER CYBER TEAM"$i"         |"
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" INDONESIA HACKER CYBER TEAM  [FR13ND8]"$i"          |"
echo $i" |"$pu" FACEBOOK :"$ku" Putri"$i"                   |"
...
echo $i" |"$pu" Contack Gmail :"$ku" cyberteam@gmail.com"$i"      |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
...
sleep 2
echo $ku"WhatsApp :"$i" 08888007115"
echo $ku"Facebook :"$i" Putri"
sleep 2
